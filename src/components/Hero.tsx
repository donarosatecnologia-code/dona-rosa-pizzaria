  ...
  return (
    <section className="section-paper relative min-h-[70vh] flex items-center justify-center pt-16 overflow-hidden">
      <img
        src={alecrim}
        alt=""
        className="absolute left-0 top-20 h-72 opacity-40 hidden lg:block pointer-events-none"
      />
      <img
        src={trigo}
        alt=""
        className="absolute right-4 bottom-10 h-64 opacity-40 hidden lg:block pointer-events-none"
      />
      <div className="text-center py-16 px-4">
        <img
          src={logoFull}
          alt="Dona Rosa Pizzaria"
