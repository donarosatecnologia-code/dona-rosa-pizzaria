  ...
  return (
    <section id="cardapio" className="section-paper py-16 md:py-24 relative overflow-hidden">
      <img
        src={trigo}
        alt=""
        className="absolute right-0 top-0 h-40 opacity-30 hidden lg:block pointer-events-none"
      />
      <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex items-center gap-4 justify-center">
            ...
            <div className="flex gap-4 overflow-hidden">
              {data.images.map((img, i) => (
                <div
                  key={i}
                  className={`shrink-0 w-48 md:w-64 rounded-xl overflow-hidden transition-transform duration-300 ${
        ...
        <a href="#" className="btn-secondary-dr inline-block mt-8">
          {data.ctaLabel}
        </a>
      </div>
    </section>
