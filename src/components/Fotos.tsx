    ...
    <>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {data.images.map((img, i) => (
              <EditableWrapper key={i} id={`home-fotos-img-${i}`} type="gallery" label={`Foto ${i + 1}`}>
                <button
      ...
      {lightboxIndex !== null && (
        <div className="fixed inset-0 z-[100] bg-black/90 flex items-center justify-center" onClick={closeLightbox}>
          ...
          <img src={data.images[lightboxIndex].src} alt={data.images[lightboxIndex].alt} className="max-w-[90vw] max-h-[85vh] object-contain rounded-lg shadow-2xl" onClick={(e) => e.stopPropagation()} />
