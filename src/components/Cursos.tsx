...
const defaultData: CursosData = {
  ...
  description:
    'Quer aprender a fazer pizza artesanal e conhecer nossos segredos e dicas especiais? Confira nossos Cursos e Eventos para entusiastas da culinária!',
  images: [
