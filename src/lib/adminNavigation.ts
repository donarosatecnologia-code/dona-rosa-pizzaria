...
export const ADMIN_MORE_NAV: AdminNavItem[] = [
  ...
  { to: "/admin/disparos", label: "Mensagens ativas", icon: Send, matchPrefix: "/admin/disparos" },
  { to: "/admin/templates", label: "Template de mensagens", icon: FileText, matchPrefix: "/admin/templates" },
